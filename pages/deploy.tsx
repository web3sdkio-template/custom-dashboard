...
import { ContractType } from "@web3sdkio/sdk";
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        {/* Top Section */}
        <h1 className={styles.h1}>web3sdkio Custom Dashboard</h1>
        <p className={styles.explain}>
          Learn how to dynamically create smart contracts using the web3sdkio SDK
          and view all of the contracts you&apos;ve created, similar to our{" "}
          <b>
            <a
              href="https://web3sdk.io/dashboard"
              target="_blank"
